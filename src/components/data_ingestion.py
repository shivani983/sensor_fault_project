...
class DataIngestion:
    ...
    def export_data_into_feature_stire_file_path(self)-> pd.DataFrame:
        ...
        try:
            ...
            logging.info(f"saving exported data into feature stire file path :{raw_file_path}")
    ...
    def initiate_data_ingestion(self) -> Path:
        ...
        try:
            ...
            feature_store_file_path=self.export_data_into_feature_stire_file_path()
